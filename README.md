...
- [Задание](#задание-разработка-rest-api-для-онлайн-магазина)
- [Модели](#модели)
- [Задачи](#задачи)
    - [Регистрация пользователя](#регистрация-пользователя)
    - [Авторизация пользователя](#авторизация-пользователя)
    - [Получение списка товаров (требуется аутентификация)](#получение-списка-товаров-требуется-аутентификация)
    - [Получение excel файла с списком товаров (требуется аутентификация)](#получение-excel-файла-с-списком-товаров-требуется-аутентификация)
- [Запуск и установка](#запуск-и-установка)
- [Документация API](#документация-api)
- [Отчёт](#отчёт)
    - [Механизм кеширования](#механизм-кеширования)
